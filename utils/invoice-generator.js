        ...
        try {
            ...
            if (logoPath) {
                ...
                doc.fillColor(secondaryColor)
                   .font('Helvetica-Bold')
                   .fontSize(18)
                   .text(settings?.app_name || 'ConnectWA', 100, 52);
            } else {
                doc.fillColor(primaryColor)
                   .font('Helvetica-Bold')
                   .fontSize(24)
                   .text(settings?.app_name || 'ConnectWA', 50, 50);
            }
            ...
            doc.fillColor(secondaryColor)
               ...
               .fontSize(10)
               .fillColor(textColor)
               .text(settings?.app_name || 'ConnectWA Service', 300, 168)
               .fillColor(mutedTextColor)
            ...
            doc.fillColor(mutedTextColor)
               .font('Helvetica')
               .fontSize(9)
               .text('Thank you for choosing ConnectWA for your WhatsApp marketing needs!', 50, 750, { align: 'center', width: 500 })
